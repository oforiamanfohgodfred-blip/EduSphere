...
import StudentClassSpace from "../pages/student/ClassSpace";
...
function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/teacher/resources" element={p("teacher", <Resources />)} />
      <Route path="/teacher/announcements" element={p("teacher", <Announcements />)} />
      <Route path="/teacher/profile" element={p("teacher", <Profile />)} />

      <Route path="/student/dashboard" element={p("student", <StudentDashboard />)} />
      <Route path="/student/class" element={p("student", <StudentClassSpace />)} />
      <Route path="/student/assignments" element={p("student", <StudentAssignments />)} />
      <Route path="/student/timetables" element={p("student", <StudentTimetables />)} />
      <Route path="/student/exams" element={p("student", <StudentExamNotifications />)} />
      <Route path="/student/resources" element={p("student", <StudentResources />)} />
      <Route path="/student/announcements" element={p("student", <StudentAnnouncements />)} />
      <Route path="/student/profile" element={p("student", <StudentProfile />)} />

      <Route path="/organization/dashboard" element={<OrganizationDashboard />} />
      <Route path="/organization/teachers" element={<Teachers />} />
      <Route path="/organization/students" element={<Students />} />
      <Route path="/organization/classes" element={<Classes />} />
      <Route path="/organization/classes/:id" element={<ClassDetails />} />
      <Route path="/organization/subjects" element={<Subjects />} />
